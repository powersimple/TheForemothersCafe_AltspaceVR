...
namespace UnityEditor
{
    public class BakeryShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent tripleshLabel = new GUIContent("Enable Triple (batched) SH", "Makes this material treat directional maps as triple SH, as enabled by the 'Optimize SH maps for batching' option.");
        ...
        MaterialProperty enableTripleSH = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            enableTripleSH = FindProperty("_BAKERY_TRIPLESH", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.ShaderProperty(enableTripleSH, Styles.tripleshLabel);
                if (enableSH.floatValue > 0 || enableMonoSH.floatValue > 0 || enableVertexLMSH.floatValue > 0 || enableTripleSH.floatValue > 0)
