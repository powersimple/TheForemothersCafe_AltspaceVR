Shader "Bakery/Standard"
{
    Properties
    {
        ...
        [Toggle(BAKERY_TRIPLESH)] _BAKERY_TRIPLESH ("Enable triple (batched) SH", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature BAKERY_TRIPLESH
            ...
            #pragma multi_compile _ BAKERY_MULTIVOLUME
