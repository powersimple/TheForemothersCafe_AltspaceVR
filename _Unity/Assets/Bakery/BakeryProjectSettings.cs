...
public class BakeryProjectSettings : ScriptableObject
{
    ...
    // Don't wait for the manual "Get data" click
    [SerializeField]
    public bool autoServerGetData = false;

    // Run on multiple GPUs
    [SerializeField]
    public bool multiGPULaunch = false;

    // Put map/renderer links into LightingDataAssets for improved startup performance
    [SerializeField]
    public bool newLightingDataPatch = false;
}
