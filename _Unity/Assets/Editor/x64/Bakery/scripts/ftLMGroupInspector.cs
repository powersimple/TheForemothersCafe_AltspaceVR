...
public class ftLMGroupInspector : UnityEditor.Editor
{
    ...
    SerializedProperty ftraceDisableFixPos;
    ...
    void OnEnable()
    {
        ...
        ftraceDisableFixPos = serializedObject.FindProperty("disableFixPos");
    ...
    public override void OnInspectorGUI() {
        ...
        ftraceDisableFixPos.boolValue = !EditorGUILayout.Toggle(new GUIContent("Allow sample adjustment", "Allow performing sample adjustment on this group."), !ftraceDisableFixPos.boolValue);
